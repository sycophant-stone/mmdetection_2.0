...
class CustomDataset(Dataset):
    ...
    def prepare_train_img(self, idx):
        ...
        #print("=RESIZE IMG=========================START===")
        #print("img's shape:", img.shape)
        #print("img_scale:", img_scale)

        img, img_shape, pad_shape, scale_factor = self.img_transform(
            img, img_scale, flip, keep_ratio=self.resize_keep_ratio)
        #print("After img_shape:", img_shape)
        #print("After scale_factor:", scale_factor)
        ...
        # print("=RESIZE GTBOX=========================START===")
        # print("gt_bboxes:", gt_bboxes)
        # print("img_shape:", img_shape)
        # print("scale_factor:", scale_factor)
        # print("flip:", flip)
        # gtboxes * scale_factor
        #
        gt_bboxes = self.bbox_transform(gt_bboxes, img_shape, scale_factor,
                                        flip)
        # print("gt_bboxes:", gt_bboxes)
        # print("=RESIZE GTBOX=========================E N D ===")
        if self.with_crowd:
