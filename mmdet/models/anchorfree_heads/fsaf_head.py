...
class FSAFHead(nn.Module):
    ...
    def forward(self, feats):
        # debug_feats = feats
        # debug_feats = np.array(debug_feats)
        # print("feats shape:", debug_feats.shape)
        # print("feats[0] shape", debug_feats[0].shape)
        # print("feats[1] shape", debug_feats[1].shape)
        # print("feats[2] shape", debug_feats[2].shape)
        # print("feats[3] shape", debug_feats[3].shape)
        # print("feats[4] shape", debug_feats[4].shape)
    ...
    def point_target_single(self, cls_score_list, bbox_pred_list, gt_bboxes,
        ...
        for lvl in range(num_levels):
            ...
            # print("cls_score_list[%s][0]:%s"%(lvl, cls_score_list[lvl][0].shape))
